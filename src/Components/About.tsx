    ...
    <section className="about-section" id="about">
      ...
      <p>
       As a self-taught front-end developer, I am excited to present my
        ...
        such as HTML, CSS, JavaScript, TypeScript and front-end frameworks like
        React, Nextjs. I'm also well-versed in design tools such as Figma.  
         I am a quick learner and always eager to improve my skills. I have a
